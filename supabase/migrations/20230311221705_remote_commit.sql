...
--
-- Name: working_tasks; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE "public"."working_tasks" (
    "id" "uuid" NOT NULL,
    "start_time" timestamp with time zone NOT NULL,
...
ALTER TABLE "public"."working_tasks" OWNER TO "postgres";
...
--
-- Name: working_tasks working_task_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."working_tasks"
    ADD CONSTRAINT "working_task_pkey" PRIMARY KEY ("id");


--
-- Name: completed_tasks completed_tasks_ref_task_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."completed_tasks"
    ADD CONSTRAINT "completed_tasks_ref_task_fkey" FOREIGN KEY ("ref_task") REFERENCES "public"."tasks"("id");
...
ALTER TABLE ONLY "public"."completed_tasks"
    ADD CONSTRAINT "completed_tasks_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id");
...
--
-- Name: working_tasks working_tasks_ref_task_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."working_tasks"
    ADD CONSTRAINT "working_tasks_ref_task_fkey" FOREIGN KEY ("ref_task") REFERENCES "public"."tasks"("id");


--
-- Name: working_tasks working_tasks_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."working_tasks"
    ADD CONSTRAINT "working_tasks_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id");


--
-- Name: tasks Enable insert for authenticated users only; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: working_tasks ONly authenticated users can do actions; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "ONly authenticated users can do actions" ON "public"."working_tasks" USING (("auth"."uid"() = "user_id")) WITH CHECK (("auth"."uid"() = "user_id"));


--
-- Name: user_settings Only auth users; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Only auth users" ON "public"."user_settings" USING (("auth"."uid"() = "user_id")) WITH CHECK (("auth"."uid"() = "user_id"));


--
-- Name: completed_tasks Only authenticated users can do actions; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Only authenticated users can do actions" ON "public"."completed_tasks" USING (("auth"."uid"() = "user_id")) WITH CHECK (("auth"."uid"() = "user_id"));


--
-- Name: tasks User can delete their tasks; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "User can delete their tasks" ON "public"."tasks" FOR DELETE USING (("auth"."uid"() = "user_id"));


--
-- Name: tasks Users can only update tasks associated with them; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Users can only update tasks associated with them" ON "public"."tasks" FOR UPDATE USING (("auth"."uid"() = "user_id")) WITH CHECK (("auth"."uid"() = "user_id"));


--
-- Name: tasks Users can read their own tasks; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: completed_tasks; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: working_tasks; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE "public"."working_tasks" ENABLE ROW LEVEL SECURITY;
...
--
-- Name: TABLE "completed_tasks"; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE "working_tasks"; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE "public"."working_tasks" TO "anon";
GRANT ALL ON TABLE "public"."working_tasks" TO "authenticated";
GRANT ALL ON TABLE "public"."working_tasks" TO "service_role";
